...
exports.sendBanEmail = sendBanEmail;
exports.sendUnbanEmail = sendUnbanEmail;
...
async function sendBanEmail(email, name, reason) {
...
async function sendUnbanEmail(email, name) {
